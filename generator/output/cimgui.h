...
CIMGUI_API float* ImVector_float_find(ImVector_float* self,const float v);
CIMGUI_API ImWchar* ImVector_ImWchar_find(ImVector_ImWchar* self,const ImWchar v);
CIMGUI_API char* ImVector_char_find(ImVector_char* self,const char v);
CIMGUI_API float const * ImVector_float_find_const(const ImVector_float* self,const float v);
CIMGUI_API ImWchar const * ImVector_ImWchar_find_const(const ImVector_ImWchar* self,const ImWchar v);
CIMGUI_API char const * ImVector_char_find_const(const ImVector_char* self,const char v);
CIMGUI_API bool ImVector_float_find_erase(ImVector_float* self,const float v);
CIMGUI_API bool ImVector_ImWchar_find_erase(ImVector_ImWchar* self,const ImWchar v);
CIMGUI_API bool ImVector_char_find_erase(ImVector_char* self,const char v);
CIMGUI_API bool ImVector_float_find_erase_unsorted(ImVector_float* self,const float v);
CIMGUI_API bool ImVector_ImWchar_find_erase_unsorted(ImVector_ImWchar* self,const ImWchar v);
CIMGUI_API bool ImVector_char_find_erase_unsorted(ImVector_char* self,const char v);
